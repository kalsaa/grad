...
class DashboardUI:
    ...
    def _create_charts_area(self):
        ...
        self.charts_frame.columnconfigure(0, weight=3)  # Main chart column
        self.charts_frame.columnconfigure(1, weight=2)  # Side chart column
        self.charts_frame.rowconfigure(0, weight=2)     # Top row taller
        self.charts_frame.rowconfigure(1, weight=2)     # Middle row
        self.charts_frame.rowconfigure(2, weight=2)     # Bottom row
    ...
    def _create_traffic_chart(self):
        ...
        traffic_frame.grid(row=0, column=0, sticky="nsew", padx=8, pady=8)
    ...
    def _create_auth_charts(self):
        ...
        auth_frame.grid(row=0, column=1, sticky="nsew", padx=8, pady=8)
    ...
    def _create_memory_chart(self):
        ...
        memory_frame.grid(row=1, column=0, columnspan=2, sticky="nsew", padx=8, pady=8)
    ...
    def _create_bottom_chart(self):
        ...
        bottom_frame.grid(row=2, column=0, columnspan=2, sticky="nsew", padx=8, pady=8)
